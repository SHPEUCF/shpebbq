export const companyData = [
    {
      name: "Accenture", 
      img: require("../assets/accenturePretty.jpg"),
    ...
    {
      name: "DATIS", 
      img: require("../assets/datisPretty.jpeg"),
    ...
    },
    {
      ...
      img: require("../assets/kennedyPretty.jpg"),
    ...
    {
      name: "Kimley Horn", 
      img: require("../assets/kimleyHorn.jpg"),
    ...
    },
    {
      ...
      img: require("../assets/lockheedmartinPretty.jpg"),
    ...
    {
      name: "PwC", 
      img: require("../assets/pwcPretty.jpg"),
    ...
    },
    {
      ...
      img: require("../assets/sandiaLabs.jpg"),
    ...
    {
      name: "Thales", 
      img: require("../assets/thalesP.jpg"),
    ...
    // },
    {
      ...
      {
        name: "Enercon", 
        img: require("../assets/enerconPPl.jpg"),
        title: "Why Enercon",
      ...
      {
        name: "IBM", 
        img: require("../assets/ibmPretty.jpg"),
      ...
      {
        name: "John Deere", 
        img: require("../assets/JohnDeereC.jpg"),
      ...
      {
        name: "Kiewitt", 
        img: require("../assets/kiewitP.jpg"),
        title: "OUR CULTURE",
